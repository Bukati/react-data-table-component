...
var DataTable = /*#__PURE__*/React.memo(function (_ref) {
  ...
  }) : /*#__PURE__*/React__default['default'].createElement(TableColCheckbox, null)), columnsMemo.map(function (column) {
    return /*#__PURE__*/React__default['default'].createElement(TableCol, {
      key: column.id,
      column: column,
      sortIcon: sortIcon
    });
  }), expandableRows && !expandableRowsHideExpander && /*#__PURE__*/React__default['default'].createElement(TableColExpander, null))), !data.length > 0 && !progressPending && /*#__PURE__*/React__default['default'].createElement(NoDataWrapper, null, noDataComponent), progressPending && persistTableHead && /*#__PURE__*/React__default['default'].createElement(ProgressWrapper, null, progressComponent), !progressPending && data.length > 0 && /*#__PURE__*/React__default['default'].createElement(TableBody, {
